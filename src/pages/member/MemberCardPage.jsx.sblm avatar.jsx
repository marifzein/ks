            ...
            <div className="relative rounded-[27px] bg-gradient-to-br from-[#3a0202] via-[#1a0505] to-[#111111] p-8">
              ...
              <div className="relative">
                ...
                <div className="mt-8 flex items-center gap-5">
                  ...
                  <img
                    src={member.photo || `https://i.pravatar.cc/300?img=${member.id}`}
                    alt={member.name}
                    className="h-20 w-20 rounded-2xl object-cover ring-2 ring-white/20 shadow-md"
                  />
                  <div>
        ...
        <div className="flex flex-col gap-5 lg:col-span-2">
          <div className="card-ik p-7">
            ...
            <p className="mt-3 text-sm leading-relaxed text-ink/55">
              ...
              memiliki nomor unik, jenjang, dan QR verifikasi yang dapat dipindai siapa pun untuk memastikan keabsahan
              keanggotaan.
            </p>
            <ul className="mt-4 flex flex-col gap-2 text-sm font-semibold text-ink/65">
              {[
                "Nomor anggota unik & permanen",
                "QR verifikasi real-time",
                "Jenjang & wilayah tertera",
                "Dapat diperbarui saat kenaikan tingkat",
              ].map((b) => (
