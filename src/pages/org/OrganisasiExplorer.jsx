      ...
      >
        {hasChildren ? (
          <button
            ...
            className="flex h-6 w-6 items-center justify-center rounded-md bg-ink/[0.06] text-ink/50 hover:text-ink"
    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="mt-1 text-sm text-ink/50">
          Alur drill-down: Indonesia → Provinsi → Kabupaten/Kota → Cabang → Ranting ·{" "}
        </p>
      </div>
                ...
                {[1, 2, 3, 4].map((k) => (
                  <div key={k} className="rounded-xl bg-surface p-4">
                    <p className="text-xs font-extrabold text-ink">
                      {province.name} — Kabupaten/Kota {k}
                    </p>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[11px] font-semibold text-ink/40">
                      {p.branches} cabang · {p.rantings} ranting
                    </p>
                  </div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="ml-auto flex gap-1.5">
                {[
                  ...
                  ["Pengda", "bg-ink"],
                  ["Cabang", "bg-blue-500"],
                  ["Ranting", "bg-white border border-ink/15"],
                ].map(([l, c]) => (
