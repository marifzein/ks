  ...
  const sidebar = (
    <div className="flex h-full flex-col">
      ...
      <nav className="mt-2 flex flex-1 flex-col gap-1 px-4">
        ...
        {!admin && (
          <Link to="/admin" className="mt-6 flex items-center gap-3 rounded-xl bg-white/[0.06] px-4 py-3 text-sm font-bold text-white/60 transition hover:bg-white/10 hover:text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] font-semibold text-ink/40">
                {admin ? 'Kelola data & pengaturan organisasi' : 'Organization Intelligence · [DATA SIMULASI]'}
              </p>
            </div>
          </div>
          <Link to="/" className="hidden items-center gap-2 rounded-full bg-ink/[0.05] px-4 py-2 text-xs font-bold text-ink/60 transition hover:bg-ink/10 sm:flex">
